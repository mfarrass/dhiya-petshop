...
<head>
    ...
    <title>Inventori Dhiya Petshop</title>
  <!-- BOOTSTRAP STYLES-->
  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand text-capitalize" href="index.php">Hi, <?php echo $_SESSION['nama']; ?></a> 
      </div>
      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          <li class="text-center">
            ...
            <img src="gambar_admin/logo-white.png" class="user-image img-circle img-responsive"/>
          </li>
          <li>
            <a  class="" href="index.php"><i class="fa fa-home"></i> Dashboard</a>
          </li> 
          <li>
            <a  href="#"><i class="fa fa-shopping-cart"></i> Pembelian<span class="fa arrow"></span></a>
          ...
          <li>
            <a  href="index.php?page=supplier"><i class="fa fa-truck"></i> Supplier</a>
          </li>
          <li>
          ...
          <li>
            ...
            <ul class="nav nav-second-level">
              ...
              <li>
                <a  href="index.php?page=perusahaan"><i class="fa fa-home"></i> Toko</a>
              </li>
            </ul>
          </li>
          <li>
